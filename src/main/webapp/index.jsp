...
<title>Home Page | SUN RISE HOSPITALS</title>
...
<body>
	...
	<div id="carouselExampleIndicators" class="carousel slide"
		...
		<div class="carousel-inner">
			...
			<div class="carousel-item">
				<img src="images/hospital4.jpg" class="d-block w-100" alt="..."
					height="500px">
			</div>
			<div class="carousel-item">
	...
	<div class="container p-2">
		...
		<div class="row">
			<div class="col-md-3">
				<div class="card my-card">
					<div class="card-body text-center">
						...
						<p class="fw-bold fs-5">Dr.M.Madhan Mohan Reddy</p>
			...
			<div class="col-md-3">
				<div class="card my-card">
					<div class="card-body text-center">
						<img alt="" src="images/picDoc2.jpg" height="300px" width="230px">
						<p class="fw-bold fs-5">Dr. Gaddam Sameera Reddy</p>
			...
			<div class="col-md-3">
				<div class="card my-card">
					<div class="card-body text-center">
						<img alt="" src="images/wdoc.jpg" height="300px" width="230px">
						<p class="fw-bold fs-5">Dr. M.Harshitha Reddy</p>
						<p class="fs-7">(Chief Doctor)</p>
					</div>
				</div>
			</div>
			...
			<div class="col-md-3">
				<div class="card my-card">
					<div class="card-body text-center">
						<img alt="" src="images/mdoc.jpeg" height="300px" width="230px">
						<p class="fw-bold fs-5">Dr. M.Harshavardhan Reddy</p>
						<p class="fs-7">(Dean)</p>
					</div>
				</div>
			</div>
