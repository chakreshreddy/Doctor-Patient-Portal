			...
			<div class="col-md-4 offset-4">
				<div class="card my-card">
					<div class="card-body">
						...
						//which is coming from url for doctor editing (which I pass through the URL when pressing edit doctor)...
						int id = Integer.parseInt(request.getParameter("id")); //this "id" is a prefix name in the URL
						DoctorDao docDAO = new DoctorDaoImple();
						Doctor doctor = docDAO.getDoctorById(id);//call getDoctorById(id) which returns the doctor of a specific id
						%>
						...
						<form action="../updateDoctor" method="post">
							...
							<!-- for updating data of a specific user's id used "hidden" id -->
							<div class="mb-3">
